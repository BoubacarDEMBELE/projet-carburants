# Projet 2 — Prix des carburants : pipeline ETL serverless

![Collecte quotidienne](https://github.com/BoubacarDEMBELE/projet-carburants/actions/workflows/carburants_daily.yml/badge.svg)
...
GitHub Actions (runner Ubuntu, éphémère, 6h UTC)
        ...
        ├──────────────► data/carburants/AAAA-MM-JJ.csv.gz   (archive froide, Git)
...
| Git (`data/carburants/`) | historique complet, compressé | illimité | archive, rejeu, analyses longues |
...
├── schema.sql                          tables, index, vue, requêtes d'analyse
└── README.md                           ce fichier

à la racine du dépôt :
├── .github/workflows/carburants_daily.yml   cron quotidien + commit de l'archive
├── data/carburants/                         archive froide (générée)
...
Créer les tables : exécuter `carburants/schema.sql` dans le SQL Editor de Supabase.
...
*Projet 2 du parcours. Voir le [README du dépôt](../README.md) pour l'ensemble des projets.*
